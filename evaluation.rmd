...
save_plot(pCalib_pl, "results/calibration_probabilistic.png", w = 21, h = 21)
```
...
mCalib_pl <- df_mCalib %>%
  ...
  scale_x_continuous(breaks = inc_small_brks, limits = c(10, 160), expand = c(0,0)) +
...
save_plot(mCalib_pl, "results/calibration_marginal.png", w = 21, h = 10)
```
...
sharp_pl <- df_sharp %>%
  ...
  labs(x = "Number of days forecasted ahead", 
       y = paste0("Size of ", qq_name, "% credible interval (incidence in cases per 100,000 population)"),
       title = "Sharpness",
       subtitle = paste0("Average size of ", qq_name, "%-credible interval by method and N-day ahead forecast")) +
  theme_bw2() +
  theme(legend.title = element_blank())

sharp_pl

save_plot(sharp_pl, paste0("results/sharpness_q", qq_name, ".png"), w = 21, h = 21)
```
